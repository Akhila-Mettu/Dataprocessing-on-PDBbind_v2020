...
# ro5_prop= df11['Smiles col'].apply(ro5_property_estimation) #how to apply
# mol_ro5_fulfilled = df1[df1["ro5_fulfilled"]] #subset of df with ro5 fulfilled.
# mol_ro5_violated = df1[~df1["ro5_fulfilled"]] #subset of df with ro5 not fulfilled.
...
# mol_with_atom_index(df1['mol'].iloc[1374])# how to apply
...
# df2=car_acids(df1) #how to apply the above function
...
# df2=aliphatic_atom_count(df1) ##how to apply the above function #>5 remove
...
# df2=chiral_center_and_ringcount(df1)  #how to apply the above function
...
# df2=FusedRingCount(df1) #how to apply the above function
...
# PandasTools.SaveXlsxFromFrame(df,'C:/Users/Akhila/Desktop/df.xlsx', molCol='mol', size=(250,250))
...
# df['mol'].apply(protonate_ali_amino)
...
def deprotonation_cooh(df):
    ...
    return df
# df2=deprotonation_cooh(df1)

# Rules  
# Number of carboxyl groups + Number of amino N (with aliphatic neighbors) <= 2
# 
# 2) Number of long aliphatic chains < 6
# 
# 3) Number of four fused ring system < 1
# 
# 4) Number of chiral centers < 3
# 
# 5) Number of cycles > 0
